...
class LinkAPIFtx extends StatefulWidget {

  @override
  LinkAPIFtxState createState() => LinkAPIFtxState();
}

class LinkAPIFtxState extends State<LinkAPIFtx> {
            ...
            children: <Widget> [
              ...
              Flexible(
                ...
                child: Align(
                  ...
                  child: Text("Link FTX API", style: TextStyle(fontSize: 22)),
                )
              ),
              Flexible(
                flex: 2,
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () => {
                        ...
                        if(_publicApiTextController.text.length != 40) {
                        ...
                        } else if(_secretApiTextController.text.length != 40) {
                          setState(() {
                            _secretValidate = false;
                          ...
                          _secretValidate = true,
                          _publicValidate = true,
                          Navigator.pushNamed(context, '/checkftxapi', arguments: {'api': _publicApiTextController.text, 'sapi': _secretApiTextController.text}),
                          setState(() {
                          })
                        }
                      },
