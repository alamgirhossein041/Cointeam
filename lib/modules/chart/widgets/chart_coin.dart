...
class ChartIndividual extends StatefulWidget {
  ChartIndividual({Key key}) : super(key: key);

  @override
  _ChartIndividualState createState() => _ChartIndividualState();
}

class _ChartIndividualState extends State<ChartIndividual> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<BinanceGetIndividualChartBloc, BinanceGetIndividualChartState>(
      listener: (context, state) {
        if (state is BinanceGetIndividualChartErrorState) {
          debugPrint("error in syncfusioncharts");
        }
      },
      builder: (context, state) {
        if (state is BinanceGetIndividualChartInitialState) {
          debugPrint("BinanceGetIndividualChartInitialState");
          return Container();
        } else if (state is BinanceGetIndividualChartLoadingState) {
          debugPrint("BinanceGetIndividualChartLoadingState");
          return Container();
        } else if (state is BinanceGetIndividualChartLoadedState) {
          debugPrint("BinanceGetIndividualChartLoadedState");
          return SizedBox(
                  ...
                  child: SfCartesianChart(
                    ...
                    series: <ChartSeries> [
                      AreaSeries<SalesData, String> (
                        ...
                        dataSource: state.binanceGetIndividualChartData,
