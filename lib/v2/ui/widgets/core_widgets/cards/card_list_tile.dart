...
class CardListTileWithCategory extends StatefulWidget {
  CardListTileWithCategory({Key key, this.coinList, this.index, this.cardCoinmarketcapListModel}) : super(key: key);
  ...
  @override
  _CardListTileStateWithCategory createState() => _CardListTileStateWithCategory();
}

class _CardListTileStateWithCategory extends State<CardListTileWithCategory> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: InkWell(
                              ...
                              Row(
                                ...
                                children: <Widget> [
                                  ...
                                  Column(
                                    ...
                                    children: <Widget> [
                                      Text(
                                        "${widget.cardCoinmarketcapListModel.data[widget.index].name}",
                                        style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 14,
                                        ),
                                      ),
                                      Text("${widget.cardCoinmarketcapListModel.data[widget.index].quote.uSD.percentChange24h.toStringAsFixed(2)}%", style:TextStyle(color: Colors.grey, fontSize: 12)),
                                    ]
                                  )
                                ]
                              ),
                                ...
                                children: <Widget> [
                                  ...
                                  Column(
                                    ...
                                    children: <Widget> [
                                      Row(
                                        ...
                                        children: <Widget> [
                                          ...
                                          Column(
                                            ...
                                            children: <Widget> [
                                              Text(
                                                "\$${widget.cardCoinmarketcapListModel.data[widget.index].quote.uSD.price.toStringAsFixed(2)}",
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 16,
                                                ),
                                      ...
                                      Text(
                                        "Market Cap: \$${(widget.cardCoinmarketcapListModel.data[widget.index].quote.uSD.marketCap.toStringAsFixed(0))}",
                                        style: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 12,
                                        ),
