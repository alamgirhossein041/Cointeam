class FtxExchangeInfoModel {  /// Repository returns 1 of this object which has List result
  List<Result> result;
  bool success;

  FtxExchangeInfoModel({this.result, this.success});

  FtxExchangeInfoModel.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = [];
