...
class EnableTradingButton extends StatefulWidget {

  @override
  _EnableTradingButtonState createState() => _EnableTradingButtonState();
}

class _EnableTradingButtonState extends State<EnableTradingButton> {
  ConfettiController _controllerTopCenter;

  @override
  void initState() { 
    super.initState();
    _controllerTopCenter = ConfettiController(duration: Duration(seconds: 15));
  }
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [Colors.blueAccent[200], Colors.pink[50]],
                  ),
                  boxShadow: [
                    BoxShadow(
                ...
                child: Align(
                  alignment: Alignment.center,
                  child: Text("(Hana Click Here)", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                ),
              ),
              onTap: () => {
                ...
                //           flex: 3,
                //           fit: FlexFit.tight,
                //           child: Center(child: Text("Happy Birthday!!!1")),
